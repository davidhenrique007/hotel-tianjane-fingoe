 ...
 */
export default function ImagePlaceholder({ label, aspect = 'landscape', className = '' }: ImagePlaceholderProps) {
  return (
    <div
      className={`relative overflow-hidden rounded-2xl bg-gradient-to-br from-forest via-forest-dark to-clay-dark/80 ${aspectClass[aspect]} ${className}`}
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-6 text-center text-cream/70">
        ...
        <p className="text-xs tracking-widest2 uppercase leading-relaxed">{label}</p>
      </div>
